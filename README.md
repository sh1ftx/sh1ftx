...
<p align="center">
  <img src="https://skillicons.dev/icons?i=rust,c,cpp,cs,go,python,js,ts,php,java,bash,linux,arch,debian,neovim,vim,git,github,docker,kubernetes,nginx,terraform,ansible,githubactions,aws,cloudflare,postgres,sqlite,redis&theme=dark" />
</p>

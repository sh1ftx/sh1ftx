...
<p align="center">
  <img src="https://skillicons.dev/icons?i=rust,c,cpp,java,cs,go,python,js,ts,php,bash,linux,arch,debian,neovim,vim,git,github,docker,kubernetes,nginx,terraform,ansible,vagrant,githubactions,aws,cloudflare,postgres,sqlite,redis&theme=dark" />
</p>
